...
{% asset_img aqs_save_head.png aqs_save_head %}
...
{% asset_img aqs_self_rotate.png aqs_self_rotate %}

{% asset_img aqs_get_head.png aqs_get_head %}
...
{% asset_img 跳过已经取消的节点.png 跳过已经取消的节点 %}
